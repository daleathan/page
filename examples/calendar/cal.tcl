...
proc vTclWindow.top34 {base} {
    ...
    wm focusmodel $top passive
    wm geometry $top 236x263+1549+207; update
    wm maxsize $top 1905 1170
    wm minsize $top 1 1
    wm overrideredirect $top 0
    wm resizable $top 1 1
    ...
    text $top.tex35 \
        -background white -font font15 -foreground black -height 186 \
    ...
    .top34.tex35 configure -font font15
